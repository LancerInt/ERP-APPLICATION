    ...
    { key: 'quote_count_expected', label: 'Expected Quotes', sortable: true },
    {
      ...
      render: (_, row) => (
        <div className="flex items-center gap-1.5" onClick={e => e.stopPropagation()}>
          <button
            onClick={() => navigate(`/purchase/rfq/${row.id}`)}
          ...
          {canSendEmail('RFQ') && (
            <button
              onClick={() => navigate(`/purchase/rfq/${row.id}/send-email`)}
              className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-primary-700 bg-primary-50 rounded-lg hover:bg-primary-100 transition"
          ...
          <button
            onClick={() => navigate(`/purchase/rfq/${row.id}/send-whatsapp`)}
            className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-green-700 bg-green-50 rounded-lg hover:bg-green-100 transition"
            title="Send RFQ via WhatsApp"
          >
